...
public class ClientPageAdapter extends FragmentPagerAdapter {
    ...
    public ClientPageAdapter(@NonNull FragmentManager fm, int behavior) {
        super(fm, behavior);
    }

    public ClientPageAdapter(Context context , FragmentManager fragmentManager , int totalTabs) {
