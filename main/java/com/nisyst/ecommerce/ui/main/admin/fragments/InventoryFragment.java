...
public class InventoryFragment extends Fragment {
    ...
    @BindView(R.id.lblNoDataInventory)
    TextView lblNoDataInventory;
        ...
        dbInventory.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    Inventory inventory = postSnapshot.getValue(Inventory.class);
    ...
    private void showNoData() {
        lblNoDataInventory.setVisibility(View.VISIBLE);
        rvInventory.setVisibility(View.GONE);
    }

    private void hideNoData() {
        lblNoDataInventory.setVisibility(View.GONE);
